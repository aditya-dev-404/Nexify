  ...
  return (
    <>
     <div
            ...
            >
                <div className="home flex flex-col items-center justify-center gap-0.5 text-[var(--text-muted)] active:text-[var(--primary)] cursor-pointer">
                    <FaHome className="text-xl" />
                    <p className="text-[10px] leading-none">Home</p>
                </div>

                <div className="my-network flex flex-col items-center justify-center gap-0.5 text-[var(--text-muted)] active:text-[var(--primary)] cursor-pointer">
